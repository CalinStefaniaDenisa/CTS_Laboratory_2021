...
import ro.ase.csie.cts.g1094.dp.builder.SuperherosCatalogue;
...
//				null);
		...
		SuperherosCatalogue catalogue = new SuperherosCatalogue(new SuperheroBuilder("Joker", 200));
		Superhero joker2 = catalogue.buildJoker();
	}
